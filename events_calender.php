...
<!DOCTYPE html>
    ...
    <div class="main_">
        <div id="calendar"></div>
        <div class="addbtn">
            <button id="eventmodal" data-bs-toggle="modal" data-bs-target="#eventModal" class="btn" style="margin-top: 10px; background-color: #8773c1; color: #fff; position: relative; left: 40%;">Add Event</button>
        </div>
    </div>
